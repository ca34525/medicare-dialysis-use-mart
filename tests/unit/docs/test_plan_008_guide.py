"""Static accessibility and offline-link checks for the Plan 008 HTML guide."""
...
GUIDE_PATH = (
    ...
    / "docs"
    / "guides"
    / "008-facility-source-and-ingestion-explained.html"
)
...
def test_guide_has_required_semantic_and_accessible_structure() -> None:
    ...
    assert "@media (max-width: 38rem)" in document
...
def test_guide_is_network_free_and_contains_required_plan_evidence() -> None:
    ...
    for required_text in (
        ...
        "source_snapshot_sha256 \u00d7 CCN",
        "41 required fields",
        "101 compatible additions",
        "period",
        "availability",
        "denominator",
