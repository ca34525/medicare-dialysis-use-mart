"""Static accessibility and offline-link checks for the Plan 004 HTML guide."""
...
GUIDE_PATH = (
    REPOSITORY_ROOT / "docs" / "guides" / "004-svi-source-contract-explained.html"
)
...
class GuideParser(HTMLParser):
    """Collect structural facts required by the numbered-guide policy."""
